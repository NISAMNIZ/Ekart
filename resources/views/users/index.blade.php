                ...
                <div class="col-md-3">
                    <div class="card product-card">
                        <div class="product-image position-relative">
                            ...
                            <a href="{{route('user.product',$featuredProduct->id)}}" class="product-img"><img class="card-img-top" src="{{asset("storage/images/".$featuredProduct->image) }}" alt=""></a>
                            @else
                            <a href="{{route('user.product',$featuredProduct->id)}}" class="product-img"><img class="card-img-top" src="{{asset("storage/images/no_image_available_1.jpg") }}" alt=""></a>
                            @endif
