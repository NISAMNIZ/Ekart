  ...
  <div class="container-fluid h-custom">
    <div class="row d-flex justify-content-center align-items-center h-100">
      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        <form action="{{route('admin.doLogin')}}" method="post" id="AdminLoginForm">
          @csrf
          ...
          <div class="text-center text-lg-start mt-4 pt-2">
            <button  type="submit" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-lg AdminLoginForm"
...
<script>
  ...
  $(".AdminLoginForm").on("click",function (e) {
    ...
    $.post('{{ route('admin.doLogin') }}', $('#AdminLoginForm').serialize(), function () {
